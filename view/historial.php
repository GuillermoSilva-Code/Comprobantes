...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="historial.php" class="w3-bar-item w3-button w3-padding w3-dark-grey"><i class="fa fa-history fa-fw"></i>  Historial</a>
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="w3-container">
      <h3><b>Historial</b></h3>
      <h4><b>Aprobados</b></h4>
      <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-color">
        <tr class="w3-green">
          <th>Comprobante</th>
