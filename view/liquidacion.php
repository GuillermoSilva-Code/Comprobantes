...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="liquidacion.php" class="w3-bar-item w3-button w3-padding  w3-dark-grey"><i
          class="fa fa-dollar fa-fw"></i>  Liquidación de gastos</a>
      ...
      <div id="demoAcc" class="w3-hide w3-white w3-card">
        <a href="editar.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-wrench fa-fw"></i> Editar
          Perfil</a>
        <a href="usuarios.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  Administrar
          Usuarios</a>
      </div><br><br>
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><b><i class="fa fa-dollar"></i> LIQUIDACIÓN DE GASTOS DE VIAJE - DAXA ARGENTINA</b></h5>
    </header>
    <br>
    <div class="w3-container">
      <form>
        <div class="row">
          <div class="col-4">
            <div class="mb-3">
              ...
              <input class="form-control" id="InputLugar" type="lugar">
              </input>
            </div>
          </div>
          <div class="col-4">
          ...
          <div class="col-4">
            <div class="mb-3">
              ...
              <input class="form-control" id="InputComprobante" type="comprobante">
              </input>
            </div>
          </div>
        </div>
        <div class="mb-3">
          ...
          <input class="form-control" id="InputPresentado" type="presentado" value="Guillermo Panetta">
          </input>
        </div>
        <div class="row">
          <div class="col-6">
          ...
          <div class="col-6">
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label">Motivo del viaje:</label>
        ...
        <div class="row">
          <div class="col-8">
            <div class="mb-3">
              ...
              <input class="form-control" id="InputLugar" placeholder="" type="lugar">
              </input>
            </div>
          </div>
          <div class="col-4">
