...
?>
<?php
if (isset($_POST['boton_controlar'])) { 
  ...
  $nombreautorizar = 'Andrea Caviglia';
  ...
  $sql1 = "UPDATE comprobante SET Controlado = '$controlo', detalles = '$detalles' WHERE Nro_comprobante = '$nrocomprobante'";
  if($query4 = $connect->query($sql1)){
    echo "exito";
     $message = '<html><head>';
     $message .='
     <meta charset="utf-8">
    ...
    $message.=' <tr>
              <td style="background-color: #ecf0f1">
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: justify;font-family: sans-serif">
                  <h2 style="color: #e67e22; margin: 0 0 7px">Para: '.$nombreautorizar.'</h2>
                  <p style="margin: 2px; font-size: 15px">
                    Una nueva solicitud de '.$subject.' ha sido ingresada por '.$presentado.'. <br>Por favor, ingrese a la página para controlar la petición.<br><br>
          ...
          $message.='</table>';
    $enviado = $mailSend-> Enviar("Comprobantes |DAXA|",$presentado,"silvaguillermo38@gmail.com","Nueva solicitud de comprobante de caja", $message);
    if($enviado){
...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="controlar.php" class="w3-bar-item w3-button w3-padding w3-dark-grey"><i class="fa fa-bell fa-fw"></i>  Controlar<span class="w3-tag w3-red w3-round w3-right"><?php echo $result2['cont_controlar'] ?></span></a>
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><b><i class="fa fa-bell"></i> CONTROLAR - DAXA ARGENTINA</b></h5><br>
    </header>
    <div class="w3-container">
      ...
      <div class="w3-responsive">
        <table id="table" class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-color">
          ...
          $Select = "SELECT Comprobante, Presentado, Destino, Motivo, Fecha, Nro_comprobante, Total FROM comprobante where Rechazado LIKE '' AND Controlado LIKE ''";
          $sql = $conn->query($Select);
          if($sql-> num_rows > 0){
            while($row = $sql-> fetch_assoc()){
              echo "<tr><td>".$row["Comprobante"]."</td><td>".$row["Presentado"]."</td><td>".$row["Destino"]."</td><td>".$row["Motivo"]."</td><td>".$row["Fecha"]."</td><td>".$row["Nro_comprobante"]."</td><td>".$row["Total"]."</td></tr>";
            }
          }else{
            echo "<i>No hay comprobantes pendientes</i>";
          }
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
        <div class="form-row">
          <div class="form-group col-md-3">
            ...
            <input type="text" style="font-style:italic;" class="form-control" id="comprobante" name="comprobante">
          </div>
          <div class="form-group col-md-3">
            <label for="inputprep"><b>Preparó</b></label>
            <input type="text" style="font-style:italic;" class="form-control" id="preparo" name="preparo">
          </div>
          <div class="form-group col-md-6">
            <label for="inputdes"><b>Destino</b></label>
            <input type="text" style="font-style:italic;" class="form-control" id="destino" name="destino">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="inputnro"><b>N° Comprobante</b></label>
            <input type="text" style="font-weight:bold;" class="form-control" id="nrocomprobante" name="nrocomprobante">
          </div>
          <div class="form-group col-md-6">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" style="font-weight:bold;" class="form-control" id="controlo" value="<?php echo $result['Nombre'] . " " . $result['Apellido'] ?>" name="controlo">
          </div>
          <div class="form-group col-md-3">
            <label for="inputfec"><b>Fecha</b></label>
            <input type="text" style="font-weight:bold;" class="form-control" id="fecha" name="fecha">
          </div>
          <div class="form-group col-md-3">
            ...
            <div class="input-group">
              ...
              <input type="text" style="font-weight:bold;" class="form-control" id="total" name="total">
            </div>
          </div>
        </div>
        <div class="form-group">
          <label for="inputMail"><b>Detalles</b></label>
          <input type="text" class="form-control" id="detalles" placeholder="Detalles de la operación / Motivo del rechazo" aria-describedby="emailHelp" name="detalles">
        </div>


        <!-- Botones -->
        <button type="submit" class="btn btn-primary" name="boton_controlar" style="margin-left:10px;">Controlar</button>
